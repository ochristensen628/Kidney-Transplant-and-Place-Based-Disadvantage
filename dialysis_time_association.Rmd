...
# Insert baseline row
lm_df <- lm_df %>%
  rbind(data.frame(decile = 5, exp_coeff_svm = 1, exp_coeff_svi = 1, exp_coeff_dci = 1))
...
# Save to PDF
ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Linear Model Graph.pdf", plot = lm_df_visual, height = 4, units = "in")
```
...
# Save to PDF
ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Log of Linear Model Graph.pdf", plot = lm_log_df_visual, height = 4, units = "in")
```
...
# Insert baseline row
lr_df <- lr_df %>%
  rbind(data.frame(decile = 5, SVM = 1, SVI = 1, DCI = 1))
...
# Save to PDF
ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Logistic Regression of Preemptive Listing Graph.pdf", plot = lr_df_visual, height = 4, units = "in")
```
...
o_blood_df <- cbind(o_blood_svm, o_blood_svi, o_blood_dci) %>% # Join data sets by columns
  select(-SVI_decile, -DCI_decile) %>% # Remove extra decile columns
  rename(decile = SVM_decile) # Change name to "decile"
o_blood_df

rm(o_blood_dci, o_blood_svi, o_blood_svm) # Remove intermediate data

# Reshape data set
o_blood_df <- o_blood_df %>%
  pivot_longer(cols = c(SVM, SVI, DCI), # Select columns to reshape data by
...
ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Percentage O Blood Type by Decile.pdf", plot = o_blood_df_visual, height = 4, units = "in")

ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Faceted Percentage O Blood Type by Decile.pdf", plot = facet_o_blood_df_visual, height = 4, units = "in")
```
...
# Save to PDF
ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Median Dialysis Time v. Decile.pdf", plot = dialysis_v_decile_viz, height = 4, units = "in")
```
...
# Save to PDF
ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Preemptive Listing Percentages.pdf", plot = preemp_df_visual, height = 4, units = "in")

ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Preemptive Listing Percentages facets.pdf", plot = preemp_df_visual_facet, height = 4, units = "in")
```
...
# Combine data frames
epts_df <- cbind(epts_svm, epts_svi, epts_dci) %>% # Bind by columns
  select(-SVI_decile, -DCI_decile) %>% # Remove extra decile columns
  rename(decile = SVM_decile) # Rename to have single decile column
epts_df

rm(epts_dci, epts_svi, epts_svm) # Remove excess data frames

epts_df <- epts_df %>%
  pivot_longer(cols = starts_with("svm") | starts_with("svi") | starts_with("dci"),
...
# Save to PDF
ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Mean EPTS v. Decile.pdf", plot = epts_df_visual, height = 5, units = "in")
```
...
# Combine all data sets
epts_20_df <- cbind(epts_20_svm, epts_20_svi, epts_20_dci) %>% # Bind by columns
  select(-SVI_decile, -DCI_decile) %>% # Remove extra decile columns
  rename(decile = SVM_decile) # Rename to have single decile column
epts_20_df

rm(epts_20_svm, epts_20_svi, epts_20_dci)

# Reshape data
epts_20_df <- epts_20_df %>% 
  pivot_longer(cols = c(SVM, SVI, DCI), # Turn the data for easier graphing (columns to rows)
               names_to = "index", # Set name of columns to "index"
               values_to = "percent") # Set value of columns to "percent"
...
# Save to PDF
ggsave("/Users/edgaraguila/Desktop/ALl Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/Top 20 EPTS Graph.pdf", plot = epts_20_df_visual, height = 5, units = "in")
```
...
# Insert baseline row
zinb_df <- zinb_df %>%
  rbind(data.frame(decile = 5, SVM_ct = 1, SVM_0 = 1, SVI_ct = 1, SVI_0 = 1, DCI_ct = 1, DCI_0 = 1))
...
# Rehspae Data Frame
zinb_df <- zinb_df %>%
  pivot_longer(cols = c(SVM_ct, SVM_0, SVI_ct, SVI_0, DCI_ct, DCI_0),
               names_to = "index",
               values_to = "coeff") %>%
...
# Save to PDF
ggsave("/Users/edgaraguila/Desktop/All Projects/Research Projects/UChicago Research/Data/dialysis_time_association Graphs/ZINB Exponentiated Models.pdf", plot = zinb_df_visual, height = 4, units = "in")
```